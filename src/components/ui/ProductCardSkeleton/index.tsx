...
export default function ProductCardSkeleton({ useCheckoutLayout = false }: ProductCardSkeletonProps) {
    return (
        <div className={`${mainStyles.container} ${useCheckoutLayout ? mainStyles['container--checkout'] : ''}`}>
            <div className={`${mainStyles.imageContainer} ${useCheckoutLayout ? mainStyles['imageContainer--checkout'] : ''}`}>
                <div className={skeletonStyles.skeleton__image} />
            </div>
            <div className={`${mainStyles.contentContainer} ${useCheckoutLayout ? mainStyles['contentContainer--checkout'] : ''}`}>
                <div className={`${mainStyles.contentContainer_info} ${useCheckoutLayout ? mainStyles['contentContainer--checkout_info'] : ''}`}>
                ...
                {!useCheckoutLayout && (
                    <div className={skeletonStyles.skeleton__button} />
                )}
                {useCheckoutLayout && (
